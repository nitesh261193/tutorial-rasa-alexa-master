    ...
    def blueprint(self, on_new_message):
        ...
        async def receive(request):
            ...
            if intenttype == "LaunchRequest":
                message = "<speak>Hello! Welcome to this Rasa-powered Alexa skill. You can start by saying " \
                          "'hi'.</speak>"
                session = "false"
            else:
                ...
                if intent == "AMAZON.StopIntent":
                    session = "true"
                    message = "<speak><voice name=" + "'Kendra'" + ">Talk to you later</voice></speak>"
                else:
                    ...
                    message = responses[0]
                    message = sentiment_for_each_sentence(message)
                    session = "false"
